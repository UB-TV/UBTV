        ...
        <>
            <div className='max-w-[256px] h-fit flex flex-col gap-3 p-3 shadow-1 rounded-md'>
                ...
                <div className="flex items-center justify-between gap-3">
                    <Button type="button" label="Detail" style="Filled" color="Primary" width="Fit" size="Small" className="min-w-[30%]" onClick={toggleDialogDetail} />
                    <Button type="button" label="Revisi" style="Outlined" color="Primary" width="Fit" size="Small" className="min-w-[30%]" onClick={toggleDialogRevision} />
                    <IconButton icon="/icon/delete.svg" color="Error" style="Filled" />
                </div>
            </div>
            {/* Detail Dialog */}
            ...
            <Dialog size="Normal" toggleDialog={toggleDialogRevision} ref={revisionlRef}>
                ...
                <RevisionForm onCloseDialog={toggleDialogRevision} />
            </Dialog>
        </>
    )
}
